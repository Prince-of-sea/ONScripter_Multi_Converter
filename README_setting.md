...
## メニューバー
 ...
 - **このソフトについて - ライセンス**<br>
 使われているライブラリなどのライセンスを表示します<br>
 手動でビルドしたexeだと出ない場合があります<br>
...
## その他
 - **圧縮するnsaが大きすぎる場合**<br>
 ファイル数が20000、またはファイル容量が2000MBを超える場合、<br>
 nsaの作成に失敗して破損ファイルが出力されることがあります(詳細なしきい値は不明)<br>
 本機能は、破損を回避するために圧縮をスキップされたファイルを、<br>
 どのように扱うかを指定できます<br>
 ...
 - **ゲームアイコンを取得する**<br>
 入力元の実行ファイルからアイコンを取得し、icon.pngとして出力先に保存します<br>
